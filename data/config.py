...
COCO_CLASSES_PERSON = ['person']
COCO_LABEL_MAP_PERSON = {1: 1}

COCO_CLASSES_PERSON_W_NEGATIVE = ['person', 'dummy_neg']
COCO_LABEL_MAP_PERSON_W_NEGATIVE = {1: 1, 500:2}
...
coco2014_dataset_person = dataset_base.copy({
    'name': 'COCO 2014 ONLY PERSON',

    'train_info': './data/coco/annotations/person_keypoints_train2014.json',
    'valid_info': './data/coco/annotations/person_keypoints_val2014.json',

    'class_names': COCO_CLASSES_PERSON,
    'label_map': COCO_LABEL_MAP_PERSON
})

coco2014_dataset_person_w_negatives = dataset_base.copy({
    'name': 'COCO 2014 ONLY PERSON WITH NEGATIVE SAMPLES',

    'train_info': './data/coco/annotations/instances_personlike_train2014.json',
    'valid_info': './data/coco/annotations/instances_personlike_val2014.json',

    'class_names': COCO_CLASSES_PERSON_W_NEGATIVE,
    'label_map': COCO_LABEL_MAP_PERSON_W_NEGATIVE
})
...
yolact_person_config = coco_base_config.copy({
    'name': 'yolact_person',

    # Dataset stuff
    'dataset': coco2014_dataset_person,
    'num_classes': len(coco2014_dataset_person.class_names) + 1,
...
yolact_person_w_negatives_config = coco_base_config.copy({
    'name': 'yolact_person_with_negatives',

    # Dataset stuff
    'dataset': coco2014_dataset_person_w_negatives,
    'num_classes': len(coco2014_dataset_person_w_negatives.class_names) + 1,
